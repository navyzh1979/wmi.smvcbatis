...
import org.wmichina.crm.entity.example.SysNoticeExample.Criteria;
import org.wmichina.crm.entity.example.SysNoticeExample.Criterion;
...
public class SysNoticeSqlProvider {
    ...
    public String insertSelective(SysNotice record) {
        BEGIN();
        INSERT_INTO("sys_notice");
        
        if (record.getNoticeId() != null) {
            VALUES("notice_id", "#{noticeId,jdbcType=INTEGER}");
        }
        
        if (record.getNoticeName() != null) {
            VALUES("notice_name", "#{noticeName,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getNoticeName() != null) {
            SET("notice_name = #{record.noticeName,jdbcType=VARCHAR}");
        }
    ...
    protected void applyWhere(SysNoticeExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
